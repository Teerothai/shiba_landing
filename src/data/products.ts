...
export const macBooks: Product[] = [
  ...
  // ────────────────────────────────────────────
  {
    ...
    new: true,
    hot: true,
    image: "/assets/product/MacBook/macbook neo/MacBook Neo (A18 Pro) 13_.webp",
    category: "MacBook",
    brand: "Apple",
    ...
    colors: [
      { name: "Black", hex: "#1C1C1E", image: "/assets/product/MacBook/macbook neo/MacBook Neo (A18 Pro) 13_-B.webp" },
      { name: "Coral", hex: "#E8735A", image: "/assets/product/MacBook/macbook neo/MacBook Neo (A18 Pro) 13_-C.webp" },
    ...
    features: ["Apple A18 Pro", "Apple Intelligence", "Liquid Retina Display", "MagSafe Charging", "USB-C", "แบต 18 ชม."],
  },
];
...
export const packages: Package[] = [
  {
    ...
    benefits: [
      ...
      { text: "ของแถม Exclusive", sub: "(สามารถเลือกสีขาว สีดำได้)", included: false },
      { text: "เช็คยอดผ่านระบบได้", sub: "ด้วยตนเอง 24ชม." },
      { text: "ระบบคืนเงิน" },
      { text: "ออม 1 เดือนขึ้นไป", highlight: true },
    ],
  },
  {
    id: "promax",
    ...
    icon: "",
    benefits: [
      { text: "ส่วนลด 500", highlight: true },
      { text: "ของแถม 20ชิ้น", highlight: true },
  ...
  },
  {
    ...
    icon: "",
    benefits: [
      { text: "ส่วนลด 1000", highlight: true },
      { text: "ของแถม 45ชิ้น", highlight: true },
      { text: "ของแถม Exclusive", sub: "(สามารถเลือกสีขาว สีดำได้)", highlight: true },
      { text: "เช็คยอดผ่านระบบได้", sub: "ด้วยตนเอง 24ชม." },
      { text: "ระบบคืนเงิน" },
      { text: "ออม 1 เดือนขึ้นไป", highlight: true },
